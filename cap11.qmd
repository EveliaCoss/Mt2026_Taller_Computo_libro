...
2.  Mostrar todas las materias que contienen la palabra Álgebra (Columna 1).

3.  Mostrar todas las materias de sexto semestre (Columna 3).

4.  Contar cuántas materias tienen 8 créditos (Columna 2).

5.  Mostrar únicamente los nombres de las materias (Columna 1).

6.  Mostrar únicamente los créditos (Columna 2).
