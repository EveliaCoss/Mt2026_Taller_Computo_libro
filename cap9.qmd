...
3.  Descarga el archivo [`libro.txt`](https://github.com/EveliaCoss/Mt2026_Taller_Computo_libro/blob/main/ejercicios/BASH/libro.txt) de mi Github.
...
### `sed` y las combinaciones especiales
...
Seguiremos usando el contenido del archivo [`libro.txt`](https://github.com/EveliaCoss/Mt2026_Taller_Computo_libro/blob/main/ejercicios/BASH/libro.txt) para revisar las siguientes sustituciones:
