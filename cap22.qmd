...
[![Crear repositorio nuevo](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_1.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![Crear repositorio vacío](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_2.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![Información del repositorio remoto para configurar con nuestro local](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_3.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![SSH link para clonar el repositorio](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_4.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![SSH and GPG Keys](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_5.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)

Una vez ahí da clic en "Nueva llave SSH".

[![Nueva llave SSH](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_6.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![Llave pública](https://haydeeperuyero.github.io/Computo_Cientifico/img/github_7.png){width="120%"}](https://haydeeperuyero.github.io/Computo_Cientifico/git-y-github.html#github)
...
[![git push origin main](https://swcarpentry.github.io/git-novice-es/fig/github-repo-after-first-push.svg){width="120%"}](https://swcarpentry.github.io/git-novice-es/07-github.html)
...
Desde el repositorio remoto, podemos crear un nuevo archivo, por ejemplo `nuevo_archivo.txt`, escribir algo en él y guardar los cambios. GitHub realizará automáticamente un commit en el repositorio remoto.
...
(En caso de que la rama principal tenga otro nombre, reemplazar `main` por el nombre correspondiente.)

Git descargará e integrará automáticamente el nuevo commit en nuestro repositorio local.
...
Observaremos que ahora el commit realizado desde GitHub también aparece en el historial local.
:::
::::
