...
Otra forma de deshacer cambios es con `restore` y `reset`. Usualmente se requiere para deshacer:
...
Esto nos regresará a la versión del archivo del último commit.

::: callout-warning
Esto no se puede deshacer, una vez echo esto no hay forma de recuperar los cambios que se habían realizado.
:::

::: text-center
[![git restore \<archivo\>, Basado en ASPP-Latam](https://haydeeperuyero.github.io/Computo_Cientifico/img/restore-archivo.png){width="120%"}](https://github.com/aspp-latam/2023-mexico-git-and-github/blob/main/git-commands-visualizations.pdf)
:::
...
::: text-center
[![git restore --staged \<archivo\>, Basado en ASPP-Latam](https://haydeeperuyero.github.io/Computo_Cientifico/img/restore-staged.png){width="120%"}](https://github.com/aspp-latam/2023-mexico-git-and-github/blob/main/git-commands-visualizations.pdf)
:::
...
Usen `git checkout` para ver si podemos revertir el cambio. 
Veamos que nos dice el estado `git status`. 
Si usamos `git checkout -- prueba.txt` ya no veremos errores pero tampoco se restaurará el archivo.
...
::: text-center
[![git reset --soft HEAD\~1, Basado en ASPP-Latam](https://haydeeperuyero.github.io/Computo_Cientifico/img/reset-soft.png){width="120%"}](https://github.com/aspp-latam/2023-mexico-git-and-github/blob/main/git-commands-visualizations.pdf)
:::
...
::: text-center
[![git reset --mixed HEAD\~1, Basado en ASPP-Latam](https://haydeeperuyero.github.io/Computo_Cientifico/img/reset-mixed.png){width="120%"}](https://github.com/aspp-latam/2023-mexico-git-and-github/blob/main/git-commands-visualizations.pdf)
:::
...
::: text-center
[![git reset --hard HEAD\~1, Basado en ASPP-Latam](https://haydeeperuyero.github.io/Computo_Cientifico/img/reset-hard.png){width="120%"}](https://github.com/aspp-latam/2023-mexico-git-and-github/blob/main/git-commands-visualizations.pdf)
:::