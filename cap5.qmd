...
1.  Visita este enlace 👉 [unix.bioinfo.rsgecuador](https://github.com/RSG-Ecuador/unix.bioinfo.rsgecuador/tree/gh-pages) .
2.  Haz clic en el botón verde que dice **"CODE"**.
3.  Selecciona la opción **"Download ZIP"**.
4.  Elige la carpeta donde deseas guardar el archivo en tu computadora. El archivo se almacena con la extension `.zip`.
5.  Ve a la carpeta donde se guardó el archivo desde la **terminal**. Ejemplo en mi computadora:

``` bash
cd "C:/Users/ecoss/Documents/Respaldos/Github_notes/Workshop_Bash2024/data"
```

6.  Descomprime el archivo `.zip`.

``` bash
unzip unix.bioinfo.rsgecuador-gh-pages.zip
```
:::
